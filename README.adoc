...
https://docs.couchbase.com/analytics-nodejs-sdk/1.1/hello-world/overview.html[Analytics Node.js SDK Documentation].


This branch documents the 1.1 release of the SDK.
It follows the https://docs.couchbase.com/analytics-nodejs-sdk/1.1/project-docs/compatibility.html#api-version[SDK 1.1 API].
