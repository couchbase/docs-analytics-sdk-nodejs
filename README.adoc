= Couchbase Analytics Node.js SDK Documentation

This repository hosts the documentation source for the
https://docs.couchbase.com/analytics-nodejs-sdk/1.0/hello-world/overview.html[Couchbase Analytics Node.js SDK Documentation].


This branch documents the 1.0 release of the SDK.
It follows the https://docs.couchbase.com/analytics-nodejs-sdk/1.0/project-docs/compatibility.html#api-version[SDK 1.0 API].
