...
// 
// It can be seen built at https://docs.couchbase.com/nodejs-analytics-sdk/1.1/concept-docs/querying-your-data.html
...
All versions of Enterpries Analytics support client-side async requests.
